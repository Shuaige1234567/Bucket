"use strict";
(self["webpackChunkContainer_assets"] = self["webpackChunkContainer_assets"] || []).push([["src_Container_assets_src_pages_File_jsx"],{

/***/ "./node_modules/css-loader/dist/cjs.js!./src/Container_assets/assets/File.css":
/*!************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/Container_assets/assets/File.css ***!
  \************************************************************************************/
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".title .drop {\n  cursor: pointer;\n  width: 520px;\n  border-radius: 2px;\n  border-color: #eeeeee;\n  border-style: dashed;\n  color: #bdbdbd;\n  outline: none;\n  margin: auto;\n}\n.title .uploadBac {\n  position: relative;\n  padding-top: 20px;\n  padding-bottom: 20px;\n  background-color: #fafafc;\n}\n.title .uploadBac p {\n  text-align: center;\n  font-size: 20px;\n  margin-bottom: 0px !important;\n}\n\n.uploadBac .icon svg {\n  width: 35px;\n  height: 35px;\n}\n.fileTable .ant-table-tbody > tr > td {\n  max-width: 300px;\n}\n.showTable {\n  width: 100%;\n  position: relative;\n}\n.showTable .ant-spin-container {\n  transition: all 2s ease;\n}\n.action_bac {\n  width: 100%;\n  height: 32px;\n  bottom: 15px;\n  position: absolute;\n}\n.showTable .ant-pagination-prev,\n.showTable .ant-pagination-next,\n.showTable .ant-pagination-item {\n  z-index: 1;\n}\n.Action {\n  position: absolute;\n  right: 200px;\n}\n", "",{"version":3,"sources":["webpack://./src/Container_assets/assets/File.css"],"names":[],"mappings":"AAAA;EACE,eAAe;EACf,YAAY;EACZ,kBAAkB;EAClB,qBAAqB;EACrB,oBAAoB;EACpB,cAAc;EACd,aAAa;EACb,YAAY;AACd;AACA;EACE,kBAAkB;EAClB,iBAAiB;EACjB,oBAAoB;EACpB,yBAAyB;AAC3B;AACA;EACE,kBAAkB;EAClB,eAAe;EACf,6BAA6B;AAC/B;;AAEA;EACE,WAAW;EACX,YAAY;AACd;AACA;EACE,gBAAgB;AAClB;AACA;EACE,WAAW;EACX,kBAAkB;AACpB;AACA;EACE,uBAAuB;AACzB;AACA;EACE,WAAW;EACX,YAAY;EACZ,YAAY;EACZ,kBAAkB;AACpB;AACA;;;EAGE,UAAU;AACZ;AACA;EACE,kBAAkB;EAClB,YAAY;AACd","sourcesContent":[".title .drop {\n  cursor: pointer;\n  width: 520px;\n  border-radius: 2px;\n  border-color: #eeeeee;\n  border-style: dashed;\n  color: #bdbdbd;\n  outline: none;\n  margin: auto;\n}\n.title .uploadBac {\n  position: relative;\n  padding-top: 20px;\n  padding-bottom: 20px;\n  background-color: #fafafc;\n}\n.title .uploadBac p {\n  text-align: center;\n  font-size: 20px;\n  margin-bottom: 0px !important;\n}\n\n.uploadBac .icon svg {\n  width: 35px;\n  height: 35px;\n}\n.fileTable .ant-table-tbody > tr > td {\n  max-width: 300px;\n}\n.showTable {\n  width: 100%;\n  position: relative;\n}\n.showTable .ant-spin-container {\n  transition: all 2s ease;\n}\n.action_bac {\n  width: 100%;\n  height: 32px;\n  bottom: 15px;\n  position: absolute;\n}\n.showTable .ant-pagination-prev,\n.showTable .ant-pagination-next,\n.showTable .ant-pagination-item {\n  z-index: 1;\n}\n.Action {\n  position: absolute;\n  right: 200px;\n}\n"],"sourceRoot":""}]);
// Exports
...
/***/ "./src/Container_assets/assets/File.css":
/*!**********************************************!*\
  !*** ./src/Container_assets/assets/File.css ***!
  \**********************************************/
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_File_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../node_modules/css-loader/dist/cjs.js!./File.css */ "./node_modules/css-loader/dist/cjs.js!./src/Container_assets/assets/File.css");
...
/***/ "./src/Container_assets/src/pages/File.jsx":
/*!*************************************************!*\
  !*** ./src/Container_assets/src/pages/File.jsx ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var antd__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! antd */ "./node_modules/antd/es/tag/index.js");
...
/* harmony import */ var _ant_design_icons__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ant-design/icons */ "./node_modules/@ant-design/icons/es/icons/MedicineBoxTwoTone.js");
/* harmony import */ var react_redux__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react-redux */ "./node_modules/react-redux/es/index.js");
/* harmony import */ var _assets_File_css__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../assets/File.css */ "./src/Container_assets/assets/File.css");
...
function allFile() {
    ...
    if (localBuffer.length < assetExts.length && flag) {
        for (let i = 0; i < assetExts.length; i++) {
            localBuffer[i] = {
                ...
                id: assetExts[i].file_key,
            };
        }
    }
    function allWithProgress(requests) {
        ...
        for (let i = 0; i < acceptedFiles.length; i++) {
            ...
            reader.onload = function (e) {
                ...
                if (currentChunk < chunks) {
                    ...
                    if (isRepeat) {
                        antd__WEBPACK_IMPORTED_MODULE_5__["default"].error(`${fileKey} is Repeat`);
                    }
                    else {
                        console.log("ok");
                        ...
                        console.log("111111");
                        allWithProgress(chunkPromises).then((re3) => {
                            console.log(re3);
                            for (let i = 0; i < re3.length; i++) {
                                if (re3[i].ok.upload_status === true) {
                                    console.log(re3[i]);
                                    fileKeyBuffer = re3[i].ok.file_key;
                                    filename = re3[i].ok.file_name;
                                    fileTypeBuffer = Object.keys(re3[i].ok.file_extension)[0];
                                    bucketId = re3[i].ok.bucket_id.toString();
                                    setkey({});
                                    break;
                                }
                            }
        ...
        if (selectedRows.length > 0) {
            ...
            for (let i = 0; i < selectedRows.length; i++) {
                ...
                if (index !== -1) {
                    ...
                    antd__WEBPACK_IMPORTED_MODULE_5__["default"].error("Please select the file to delete!");
                    return 0;
                }
            }
            console.log(newBuffer);
            flag = newBuffer.length === assetExts.length;
            const newStorage = JSON.stringify(newBuffer);
            if (storageKey !== "")
                localStorage.setItem(storageKey, newStorage);
            setkey({});
            antd__WEBPACK_IMPORTED_MODULE_5__["default"].success("Deleted successded");
        }
        else {
            antd__WEBPACK_IMPORTED_MODULE_5__["default"].error("Please select the file to delete!");
        }
    ...
    const cancel = () => {
        antd__WEBPACK_IMPORTED_MODULE_5__["default"].error("Cancel deletion");
    };
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (tags) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement("span", null, tags.map((tag) => {
                ...
                return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_6__["default"], { color: color, key: Date.now() }, tag));
            }))),
        },
        {
            title: "Action",
            key: "action",
            render: (_, record) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_7__["default"], { size: "middle" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_8__["default"], { type: "primary", onClick: skip(record.filekey) }, "Entry"))),
        },
    ];
    const data = [];
    if (fileKeyBuffer !== "") {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "showTable" },
                ...
                react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "drop", ...getRootProps() },
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "uploadBac" },
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null,
                            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_ant_design_icons__WEBPACK_IMPORTED_MODULE_9__["default"], { className: "icon" })),
                        react__WEBPACK_IMPORTED_MODULE_0__.createElement("p", null, "Click one or drag many files to this area to upload"))))),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_10__["default"], { className: "fileTable", rowSelection: rowSelection, rowKey: (record) => record.id, columns: columns, pagination: { position: "bottomRight" }, dataSource: newData }),
        react__WEBPACK_IMPORTED_MODULE_0__.createElement("div", { className: "action_bac" },
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_7__["default"], { style: { display: newData.length > 0 ? "inline-flex" : "none" }, size: "middle", className: "Action" },
                react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_11__["default"], { title: "Are you sure to delete these files?", onConfirm: confirm, onCancel: cancel, okText: "Yes", cancelText: "No" },
                    react__WEBPACK_IMPORTED_MODULE_0__.createElement(antd__WEBPACK_IMPORTED_MODULE_8__["default"], { type: "primary" }, "Delete"))))));
}
...
//# sourceMappingURL=src_Container_assets_src_pages_File_jsx.index.js.map